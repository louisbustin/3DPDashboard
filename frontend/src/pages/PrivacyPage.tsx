...
function PrivacyPage() {
  const privacy = `<!-- markdownlint-capture -->
...
3DP Dashboard is committed to protecting and respecting your privacy. This Privacy Policy sets out how we collect and process personal information about you when you visit the website livingartstatuettes.com, when you use our products and services (our "Services"), or when you otherwise do business or make contact with us.
